...
export default function Home() {
  return (
    <main>
      <section>
        <h1>Style Guide</h1>
        <p>This is the style guild for the Code Your Dreams courses web app</p>
      </section>
      <section>
        <h2>Typography</h2>
        <p>
      ...
      <section>
        <h2>Colors</h2>
        <p>
          These are colors pulled from the Code Your Dreams website, used in the
          app.
        </p>
